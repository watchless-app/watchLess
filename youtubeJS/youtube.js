...
try {
  (function () {
    ...
    if (typeof AFV_allSettings === 'string') {
      allSettings = JSON.parse(AFV_allSettings);
    } else {
      alert('Error: Not defined AFV_allSettings');
      return;
    }
    ...
    function getStartPageHTML() {
      return (
        '<div class="afv-start-page-content"><a href="https://gotosettings.local" class="afv-start-page-top-link">Open Settings</a><div class="afv-start-page-motivation-wrapper">' +
    ...
    function handleCastIconClick(e) {
      e.preventDefault();
    ...
    function doPageChangeDOMManipulations() {
        ...
        if (window.location.href.includes("youtube.com/shorts/")){
          if(lastWatchedShortVideo){
            ...
            if(!window.location.href.includes(lastWatchedShortVideo)) {
              ...
              alert("Swiping on shorts is blocked.")
              return;
            }
          } else {
      ...
      // if (autoplayButton && disableAutoplay) {
